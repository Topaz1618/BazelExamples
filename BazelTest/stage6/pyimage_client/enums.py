...
class MaterialType(Enum):
    ...
    PUBLIC_NOTICE_OF_NO_OBJECTION = "公示无异议证明"
    REAL_ESTATE_APPLICATION = "不动产申请表"
    OWNERSHIP_SOURCE = "权属来源说明"
    DEED = "具结书"
    INTEGRATION_OF_RURAL_HOUSING_AND_LAND = "房地一体"
    ONE_HOUSEHOLD_ONE_HOUSE = "一户一宅证明"
    BOUNDARY_NOTIFICATION = "指界通知书"
    UNKNOWN = "Unknown"
...
class MaterialContentType(Enum):
    ...
    LAND_MAP = "宗地代码"
    LAND_MAP_AREA = "宗地面积"
    REAL_ESTATE_APPLICATION_LAND_MAP_NUMBER = "预编宗地代码"
    HOUSEHOLD_REGISTER = "户口"
    HOUSE_FLOOR_PLAN = "房屋平面图"
    PUBLIC_NOTICE_OF_NO_OBJECTION = "确权登记"
    PUBLIC_NOTICE_OF_NO_OBJECTION2 = "房地一体"
    REAL_ESTATE_APPLICATION = "不动产调查登记申请表"
    REAL_ESTATE_APPLICATION1 = "预编宗地代码"
    REAL_ESTATE_APPLICATION2 = "调查单位"
    OWNERSHIP_SOURCE = "权属来源说明"
    DEED = "具结书"
    BOUNDARY_NOTIFICATION = "指界通知书"
    INTEGRATION_OF_RURAL_HOUSING_AND_LAND = "农村房地一体调查收件单"
    ONE_HOUSEHOLD_ONE_HOUSE = "一户一宅证明"
    UNKNOWN = "Unknown"
